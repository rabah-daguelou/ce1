...
function poesie() {
  ...
  divLienenfoires.innerHTML= '<a href="https://www.youtube.com/watch?v=osk5BI-snio" target="blank"> Liberté chantée par les Enfoirés </a>'
  let divLiendessinsAnimes = document.createElement("div");
  divLiendessinsAnimes.innerHTML = '<a href="https://ladigitale.dev/digiview/#/v/640e8376c5681" target="blank"> Liberté en dessins animés </a>';
  ...
  let poesie = [
    ...
    },
    {
      ...
      audio: "anais_a.mp3",
      strophes: {
        strophe1: "Anais_a1.mp3",
        strophe2: "Anais_a2.mp3",
        strophe3: "Anais_a3.mp3",
        strophe4: "Anais_a4.mp3",
      },
    },
    {
      prenom: "Adam",
...
// Créer mon poème
  ...
  btnPoemeAleatoire.textContent = 'Générer un poème';
  let poemeGenere= document.createElement('audio')

  // Ecouter le bouton
  btnPoemeAleatoire.addEventListener('click', ()=> {
    
    let nombreAleatoire = aleatoire(1, 5)
  })



function aleatoire(min, max) { return Math.trunc(min + Math.random() * (max - min)) };
*/